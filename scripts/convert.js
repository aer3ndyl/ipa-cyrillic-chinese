...
PalladiumTable.set('an', 'ан');
PalladiumTable.set('aŋ', 'ань');
...
PalladiumTable.set('i̯ɛn', 'ян');
PalladiumTable.set('i̯aŋ', 'янь');
PalladiumTable.set('i̯e', 'е');
PalladiumTable.set('i̯ou̯', 'ю');
PalladiumTable.set('in', 'ин');
PalladiumTable.set('iŋ', 'инь');
PalladiumTable.set('i', 'и');
PalladiumTable.set('u̯a', 'уа');
PalladiumTable.set('u̯ai̯', 'уай');
PalladiumTable.set('u̯an', 'уан');
PalladiumTable.set('u̯aŋ', 'уань');
PalladiumTable.set('u̯o', 'о');
PalladiumTable.set('u̯ei̯', 'уй');
PalladiumTable.set('u̯ən', 'ун');
PalladiumTable.set('ʊŋ', 'унь');
PalladiumTable.set('u', 'у');
PalladiumTable.set('y̯ɛn', 'юaн');
PalladiumTable.set('y̯e', 'юэ');
PalladiumTable.set('yn', 'юнь');
PalladiumTable.set('i̯ʊŋ', 'юнь');
